...
async function main() {
    ...
    const landlordPassword = await bcryptjs_1.default.hash('LandlordPass123!', 10);
    const studentPassword = await bcryptjs_1.default.hash('StudentPass123!', 10);
    // Admin
    ...
    const verifiedLandlord1 = await prisma.user.create({
        data: {
            ...
            role: client_1.UserRole.LANDLORD,
            isVerified: true,
            isActive: true,
        },
    });
    ...
    const listingsToCreate = [
        {
            ...
            description: 'Bright and spacious garden flat with private entrance, fully furnished with contemporary appliances. Walking distance to Wits campus and Gautrain station. Features 24-hour security complex, fast uncapped fibre, and secure covered parking.',
            accommodationType: client_1.AccommodationType.BACHELOR,
            pricePerMonth: 6800,
            ...
            availabilityStatus: client_1.ListingAvailability.AVAILABLE,
            approvalStatus: client_1.ListingApprovalStatus.APPROVED,
        ...
        },
        {
            ...
            description: 'Spacious, friendly communal student house in the vibrant heart of Observatory. Furnished rooms with private desks, shared high-spec kitchen, open living areas, and sunny braai courtyard. Near UCT Jammie Shuttle stop and Groote Schuur.',
            accommodationType: client_1.AccommodationType.SHARED_HOUSE,
            pricePerMonth: 4200,
            ...
            availabilityStatus: client_1.ListingAvailability.LIMITED,
            approvalStatus: client_1.ListingApprovalStatus.APPROVED,
        ...
        },
        {
            ...
            description: 'Purpose-built premium student residence directly adjacent to UP Hatfield main campus. All inclusive option available. Study facilities with backup power (no load-shedding), on-site gym, biometric 24/7 security, and social lounge.',
            accommodationType: client_1.AccommodationType.STUDENT_RESIDENCE,
            pricePerMonth: 5500,
        ...
        },
        {
            ...
            description: 'Comfortable and secure apartment complex tailored for TUT Soshanguve students. Within quick walking distance to campus gates. Gated perimeter with 24/7 guard, borehole water backup, and prepaid electricity.',
            accommodationType: client_1.AccommodationType.APARTMENT,
            pricePerMonth: 3200,
        ...
        },
        {
            ...
            description: 'Self-contained bachelor flat located minutes away from TUT Pretoria Campus. Complete with private kitchenette, en-suite bathroom, and secure off-street parking. Ideal for dedicated students seeking a quiet study haven.',
            accommodationType: client_1.AccommodationType.BACHELOR,
            pricePerMonth: 3800,
        ...
        },
        {
            ...
            description: 'Urban loft apartment steps from Wits main entrance. Industrial chic finishes, rooftop leisure deck, 24-hour security with concierge, fast uncapped fibre, and study lounges.',
            accommodationType: client_1.AccommodationType.APARTMENT,
            pricePerMonth: 7500,
        ...
        // Pending Listing (for testing Admin Approval Workflow)
        {
            ...
            description: 'Spacious, renovated townhouse in fashionable Melville. Features 3 bedrooms, shared garden, fast WiFi, and private study corners. Awaiting administrative review.',
            accommodationType: client_1.AccommodationType.TOWNHOUSE,
            pricePerMonth: 8900,
            ...
            availabilityStatus: client_1.ListingAvailability.AVAILABLE,
            approvalStatus: client_1.ListingApprovalStatus.PENDING,
            ownerId: verifiedLandlord1.id,
            photos: [
        ...
        // Rejected Listing (for testing Negative Visibility)
        {
            ...
            description: 'Incomplete listing with non-compliant photos.',
            accommodationType: client_1.AccommodationType.ROOM,
            pricePerMonth: 2500,
            ...
            availableRooms: 0,
            amenities: ['WiFi'],
            availabilityStatus: client_1.ListingAvailability.UNAVAILABLE,
            approvalStatus: client_1.ListingApprovalStatus.REJECTED,
    ...
    for (const item of listingsToCreate) {
        ...
        if (!campus)
            continue;
        const distanceFromCampus = calculateHaversineDistance(item.latitude, item.longitude, campus.latitude, campus.longitude);
